...
func TestCreateBoard(t *testing.T) {
	...
	mock.ExpectCommit()
	res, err := r.CreateBoard(context.Background(), board, userId)
...
func TestGetBoardById(t *testing.T) {
	...
	res, err := r.GetBoardById(context.Background(), boardId)
	assert.Equal(t, entity.Board{BoardID: entity.BoardID(1)}, res)
	assert.Equal(t, nil, err)
...
func TestGetBoardAuthors(t *testing.T) {
	...
	res, err := r.GetBoardAuthors(context.Background(), boardId)
...
func TestGetBoardPins(t *testing.T) {
	...
	res, err := r.GetBoardPins(context.Background(), boardId, limit, offset)
...
func TestUpdateBoard(t *testing.T) {
	...
	res, err := r.UpdateBoard(context.Background(), board)
	assert.Equal(t, entity.Board{BoardID: entity.BoardID(1)}, res)
	assert.Equal(t, nil, err)
...
func TestAddPinToBoard(t *testing.T) {
	...
	err = r.AddPinToBoard(context.Background(), boardId, pinId)
	assert.Equal(t, nil, err)
...
func TestDeletePinFromBoard(t *testing.T) {
	...
	mock.ExpectExec(repository.QueryDeletePinFromBoard).
		WithArgs(boardId, pinId).
		WillReturnResult(driver.ResultNoRows)
	err = r.DeletePinFromBoard(context.Background(), boardId, pinId)
	assert.Equal(t, nil, err)
...
func TestDeleteBoard(t *testing.T) {
	...
	mock.ExpectExec(repository.QueryDeleteBoard).
		WithArgs(boardId).
		WillReturnResult(driver.ResultNoRows)
	err = r.DeleteBoard(context.Background(), boardId)
	assert.Equal(t, nil, err)
...
func TestGetUserBoards(t *testing.T) {
	...
	res, err := r.GetUserBoards(context.Background(), authorId, limit, offset)
...
func TestCheckBoardAuthorExistence(t *testing.T) {
	...
	res, err := r.CheckBoardAuthorExistence(context.Background(), userId, boardId)
